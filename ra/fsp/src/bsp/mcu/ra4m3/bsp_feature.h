...
#define BSP_FEATURE_CGC_SCKDIVCR_BCLK_MATCHES_PCLKB               (1UL)             // Requires the SCKDIVCR.BCLK bits [18:16] to match SCKDIBCR.PCLKB.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS                    (0x0219UL)        // Mask of channels with data compare match (DCCR) available.
#define BSP_FEATURE_SCI_CHANNELS                                  (0x021FUL)        // Mask of available SCI channels.
...
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS                      (0x0219UL)        // Mask of channels which support CTS external pins.
...
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                        (0x0219UL)        // Mask of channels which support the UART FIFO.
